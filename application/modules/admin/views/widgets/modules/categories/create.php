    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?= base_url('painel/modulos/categorias/store') ?>">
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="slug">Slug do Módulo</label>
                                <input type="text" name="slug" class="form-control" style="text-transform:lowercase">
                            </div>
                        </div>
                    </div>
                    <hr>
