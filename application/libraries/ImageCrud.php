...
class ImageCrud {
	...
	protected $default_language_path = 'assets/admin/plugins/image_crud/languages';
	...
	protected function _library_view($view, $vars = array(), $return = FALSE)
	{
		...
		$view_file = 'assets/admin/plugins/image_crud/views/';
    ...
    protected function _get_delete_url($value)
    {
    	...
    	return site_url('painel/'.$this->ci->uri->segment(2).'/'.$this->ci->uri->segment(3).'/delete_file/'.$value);
    }
	...
	{
		include('assets/admin/plugins/image_crud/config/translit_chars.php');
	...
	protected function getState()
	{
		...
		{
			$upload_url = site_url('painel/'.$this->ci->uri->segment(2).'/'.$this->ci->uri->segment(3).'/upload_file/'.$rsegments_array[3]);
			$ajax_list_url  = site_url('painel/'.$this->ci->uri->segment(2).'/'.$this->ci->uri->segment(3).'/'.$rsegments_array[3].'/ajax_list');
			$ordering_url  = site_url('painel/'.$this->ci->uri->segment(2).'/'.$this->ci->uri->segment(3).'/ordering');
			$insert_title_url  = site_url('painel/'.$this->ci->uri->segment(2).'/'.$this->ci->uri->segment(3).'/insert_title');
		...
		{
			$upload_url = site_url('painel/'.$this->ci->uri->segment(2).'/'.$this->ci->uri->segment(3).'/upload_file');
			$ajax_list_url  = site_url('painel/'.$this->ci->uri->segment(2).'/'.$this->ci->uri->segment(3).'/ajax_list');
			$ordering_url  = site_url('painel/'.$this->ci->uri->segment(2).'/'.$this->ci->uri->segment(3).'/ordering');
			$insert_title_url  = site_url('painel/'.$this->ci->uri->segment(2).'/'.$this->ci->uri->segment(3).'/insert_title');
